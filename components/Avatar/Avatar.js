...
const Avatar = props => {
  ...
  const buildShadow = (width, hasImage) => {
    if (!hasImage) return "";
    if (width <= 50) return "shadow-none";else if (width > 50 && width <= 100) return "shadow-small";else if (width > 100 && width <= 200) return "shadow-mid";else if (width > 200) return "shadow-big";
  };

  return /*#__PURE__*/React.createElement("div", {
    className: "avatar " + buildShadow(props.size, props.img != null),
    style: {
      width: config.width,
